	...
	<section class="bg-red text-white" id="Images">
        ...
        <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="section-heading" style="font-size: 3em; font-family: 'Poppins', sans-serif;">Delete</h2>
                    <hr class="light">
                </div>
            </div>
            <div class="text-left text-bold pt-20 pb-20" style="font-family: 'Poppins', sans-serif; font-size: 1.3em;">
		...
		<form method="post" action="deleteProcess.php" onsubmit="return deletion()">
			...
			<br/><input type="submit" class="btn btn-black" value="Delete">
		</form>
	</body>
</html>
