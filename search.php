...
<html>
    ...
    <section class="bg-red text-white" id="Images">
        ...
        <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="section-heading" style="font-size: 3em; font-family: 'Poppins', sans-serif;">Search</h2>
                    <hr class="light">
	...
	<div class="text-left text-bold pt-3  ">	
		<form method="post" action="searchProcess.php">
			Typhoon Name <br/><input type="text" class="form-control" name="typhoonname" placeholder="Enter Typhoon Name"/><br/>
			<br/><input type="submit" class="btn btn-black" value="Search">
		</form>
</div>
</div>
</body>
