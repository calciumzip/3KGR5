...
<html>
    ...
    <section class="bg-red text-white" id="Images">
        ...
        <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="section-heading" style="font-size: 3em; font-family: 'Poppins', sans-serif;">Search Result</h2>
                    <hr class="light">
                </div>
            </div>
            <div class="text-center text-bold pt-4" style="font-family: 'Poppins', sans-serif; font-size: 1.3em;">
                <p>NOTE: the searching procedure is case sensitive </p>
				<?php
	...
	$flag = 0;
	$search = $_POST["typhoonname"];

	foreach($Typhoons as $typhoon) 
	{
		$id = $typhoon->getElementsByTagName("name")->item(0)->nodeValue;
		if($search == $id)
		{
			$flag = 1;
			...
			echo "<b>Typhoon Name </b> $id<br>";
			echo "<b>Wind Speed </b> $windspeed<br>";
			echo "<br><center><a class='btn btn-black' href='create.php'>Back</a></center><br>";
			break;
		}
	}	
	if($flag == 0) echo "No record found.<br><center><a class='btn btn-black' href='search.php'>Back</a></center><br>";
?>
